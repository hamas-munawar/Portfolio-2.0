...
const AboutSection = () => {
  ...
  return (
    <section
      ...
      ref={container}
    >
      <p className="font-thin text-2xl sm:text-4xl md:text-5xl md:pr-12 text-heading slide-up-and-fade">
      ...
      <p className="border-b-[1] border-gray-600 py-4 text-text slide-up-and-fade">
        This is me
      </p>
      <div className="flex flex-col md:flex-row gap-8 mx-auto">
        <h2 className="grow-1 text-2xl sm:text-3xl md:text-4xl slide-up-and-fade">
          Hi, I'm Hamas.
        </h2>
        <div className="w-full md:w-[60%] space-y-4 md:pr-10 lg:pr-24 text-text slide-up-and-fade text-lg md:text-xl">
